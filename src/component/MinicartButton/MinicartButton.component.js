...
export class MinicartButton extends PureComponent {
  static propTypes = {
    ...
    sizeSVG: PropTypes.string.isRequired,
  };
  ...
  renderSVGMinicartButton() {
    const { colorMiniCart, sizeSVG } = this.props;
    const fillPath = colorMiniCart ? '#fff' : '#43464E';
    return (
      <svg
        width={sizeSVG}
        height={sizeSVG}
